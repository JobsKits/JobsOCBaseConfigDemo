...
```mermaid
flowchart LR
  S1["method:UIButton::initByStyle3<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:203"]
  ...
  S1 -->|calls| T1
  S2["method:UIButton::initByStyle4<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:219"]
  ...
  S2 -->|calls| T2
  S3["method:UIButton::initByStyle5<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:239"]
  ...
  S3 -->|calls| T3
  S4["method:UIButton::jobsInit<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:307"]
  ...
  S4 -->|calls| T4
  S5["method:UIButton::initByViewModel<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:316"]
  ...
  S5 -->|calls| T5
  S6["method:UIButton::initByViewModel<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:316"]
  ...
  S6 -->|calls| T6
  S7["method:UIButton::initByButtonModel<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:360"]
  ...
  S7 -->|calls| T7
  S8["method:UIButton::initByButtonModel<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:360"]
  ...
  S8 -->|calls| T8
  S9["method:UIButton::initByTextModel<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:404"]
  ...
  S9 -->|calls| T9
  S10["method:UIButton::initByTextModel<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:404"]
  ...
  S16 -->|calls| T16
  S17["method:UIButton::jobsResetBtnTitleFont<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+UI/UIButton+UI.m:340"]
  ...
  S17 -->|calls| T17
  S18["method:UIButton::jobsResetBtnSubTitleFont<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+UI/UIButton+UI.m:392"]
  ...
  S18 -->|calls| T18
  S19["method:UIButton::jobsResetBtnTextViewNormalAttributedTitle<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+UI/UIButton+UI.m:523"]
  ...
  S19 -->|calls| T19
  S20["method:UIButton::jobsResetBtnTextViewNormalAttributedSubTitle<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+UI/UIButton+UI.m:536"]
  ...
  S20 -->|calls| T20
  S21["method:UIButton::jobsResetImagePlacement_Padding<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+UI/UIButton+UI.m:551"]
  T21["method:UIButton::layoutButtonWithEdgeInsetsStyle:imagePadding:<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+ImageTitleSpacing/UIButton+ImageTitleSpacing.m:12"]
  S21 -->|calls| T21
  S22["method:UIButton::selectedAttributedTitleBy<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+UIControlState/UIButton+UIControlState.m:454"]
  T22["method:ASButtonNode::setAttributedTitle:forState:<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASButtonNode.mm:357"]
  S22 -->|calls| T22
  S23["method:UIButton::normalStateAttributedTitleBy<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+UIControlState/UIButton+UIControlState.m:463"]
  T23["method:ASButtonNode::setAttributedTitle:forState:<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASButtonNode.mm:357"]
  S23 -->|calls| T23
  S24["method:UIButton::highlightedStateAttributedTitleBy<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+UIControlState/UIButton+UIControlState.m:472"]
  T24["method:ASButtonNode::setAttributedTitle:forState:<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASButtonNode.mm:357"]
  S24 -->|calls| T24
  S25["method:UIButton::disabledStateAttributedTitleBy<br/>JobsByPods/JobsNavigationTransitionMgr@Pods/Support/UIKit/UIButton/UIButton+UIControlState/UIButton+UIControlState.m:481"]
