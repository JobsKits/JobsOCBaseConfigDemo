...
```mermaid
flowchart LR
  S1["method:_JobsTimerManagerEntry::init<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:21"]
  T1["method:_JobsTimerManagerEntry::init<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:21"]
  S1 -->|calls| T1
  S2["method:JobsTimerMgr::dealloc<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:67"]
  T2["method:JobsTimerMgr::teardownAppStateObservers<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:399"]
  S2 -->|calls| T2
  S3["method:JobsTimerMgr::dealloc<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:67"]
  T3["method:JobsTimerMgr::stopAndRemoveAll<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:310"]
  S3 -->|calls| T3
  S4["method:JobsTimerMgr::shared<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:72"]
  T4["method:JobsTimerMgr::init<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:80"]
  S4 -->|calls| T4
  S5["method:JobsTimerMgr::init<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:80"]
  ...
  T6["method:JobsTimerMgr::setupAppStateObservers<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:378"]
  S6 -->|calls| T6
  S7["method:JobsTimerMgr::upsertTimerWithIdentifiable:timerType:policy:startImmediately:build:handler:<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:87"]
  T7["method:JobsTimerMgr::upsertTimerWithIdentifier:timerType:policy:startImmediately:build:handler:<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:101"]
  S7 -->|calls| T7
  ...
  T8["function:jobs_runOnMainSyncIfNeeded<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:45"]
  S8 -->|calls| T8
  ...
  T9["method:JobsTimer::stop<br/>JobsByPods/JobsOCTimer@Pods/Core/JobsTimer/JobsTimer.m:512"]
  S9 -->|calls| T9
  ...
  T10["function:jobs_trySetBoolByKVC<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:50"]
  S10 -->|calls| T10
  ...
  T13["method:JobsTimerMgr::init<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:80"]
  S13 -->|calls| T13
  ...
  T15["method:JobsTimer::start<br/>JobsByPods/JobsOCTimer@Pods/Core/JobsTimer/JobsTimer.m:367"]
  S15 -->|calls| T15
  S16["method:JobsTimerMgr::onTickVoid:block:<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:173"]
  T16["method:JobsTimerMgr::onTick:block:<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:178"]
  S16 -->|calls| T16
  S17["method:JobsTimerMgr::onFinishVoid:block:<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:191"]
  T17["method:JobsTimerMgr::onFinish:block:<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:196"]
  S17 -->|calls| T17
  S18["method:JobsTimerMgr::start:<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:210"]
  T18["function:jobs_runOnMainSyncIfNeeded<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:45"]
  S18 -->|calls| T18
  S19["method:JobsTimerMgr::start:<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:210"]
  T19["method:JobsTimer::start<br/>JobsByPods/JobsOCTimer@Pods/Core/JobsTimer/JobsTimer.m:367"]
  S19 -->|calls| T19
  ...
  T22["function:jobs_runOnMainSyncIfNeeded<br/>JobsByPods/JobsOCTimerMgr@Pods/Core/JobsTimerMgr.m:45"]
  S22 -->|calls| T22
  ...
  T25["method:JobsTimer::fireOnce<br/>JobsByPods/JobsOCTimer@Pods/Core/JobsTimer/JobsTimer.m:479"]
  S25 -->|calls| T25
```
