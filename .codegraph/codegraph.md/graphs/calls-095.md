...
flowchart LR
  ...
  S1 -->|calls| T1
  S2["function:didLoadBlock<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode.mm:368"]
  T2["method:ASButtonNode::init<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASButtonNode.mm:32"]
  S2 -->|calls| T2
  S3["function:didLoadBlock<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode.mm:387"]
  T3["method:ASButtonNode::init<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASButtonNode.mm:32"]
  S3 -->|calls| T3
  S4["function:body<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode.mm:427"]
  T4["function:body<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode.mm:427"]
  S4 -->|calls| T4
  ...
  T7["method:ASDisplayNode::baseWillDealloc<br/>JobsByPods/ManualByOCPods@Pods/Texture/examples/CatDealsCollectionView/Sample/ASDisplayNode+CatDeals.mm:29"]
  S7 -->|calls| T7
  ...
  T9["function:scheduleIvarsForMainThreadDeallocation<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASMainThreadDeallocation.mm:18"]
  S9 -->|calls| T9
  ...
  T25["method:ASNodeController::nodeDidLoad<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASNodeController+Beta.mm:75"]
  S25 -->|calls| T25
```
