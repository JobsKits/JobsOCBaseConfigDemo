...
flowchart LR
  ...
  T6["method:ASNodeController::nodeDidLayout<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASNodeController+Beta.mm:76"]
  S6 -->|calls| T6
  ...
  T7["method:ASDisplayNode::_pendingLayoutTransitionDidComplete<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode+Layout.mm:1009"]
  S7 -->|calls| T7
  ...
  T10["function:ASDisplayLog<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/Base/ASLog.mm:41"]
  S10 -->|calls| T10
  ...
  T12["method:ASNodeController::hierarchyDisplayDidFinish<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASNodeController+Beta.mm:91"]
  S12 -->|calls| T12
  ...
  T13["method:ASNodeController::hierarchyDisplayDidFinish<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASNodeController+Beta.mm:91"]
  S13 -->|calls| T13
  ...
  S15 -->|calls| T15
  S16["function:recursivelyTriggerDisplayForLayer<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode.mm:1386"]
  T16["method:CALayer::asyncdisplaykit_node<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode.mm:3777"]
  S16 -->|calls| T16
  S17["function:recursivelyTriggerDisplayForLayer<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode.mm:1386"]
  ...
  S17 -->|calls| T17
  S18["function:recursivelyTriggerDisplayForLayer<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode.mm:1386"]
  T18["function:recursivelyTriggerDisplayForLayer<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode.mm:1386"]
  S18 -->|calls| T18
  ...
  T19["function:recursivelyTriggerDisplayForLayer<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode.mm:1386"]
  S19 -->|calls| T19
  ...
  T21["function:ASDisplayNodePerformBlockOnEveryNode<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNodeExtras.mm:85"]
  S21 -->|calls| T21
  ...
  S22 -->|calls| T22
  S23["function:backgroundColor<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode.mm:1502"]
  T23["function:ASPerformBlockOnMainThread<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASInternalHelpers.mm:133"]
  S23 -->|calls| T23
  S24["function:backgroundColor<br/>JobsByPods/ManualByOCPods@Pods/Texture/Source/ASDisplayNode.mm:1502"]
