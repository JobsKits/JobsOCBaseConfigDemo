...
flowchart LR
  ...
  S4 -->|calls| T4
  S5["method:NSString::urlProtect<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/NSString/NSString+URL/NSString+URL.m:38"]
  T5["method:NSString::containsString<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/NSString/NSString+Check/NSString+Check.m:29"]
  S5 -->|calls| T5
  S6["method:UIButton::makeBtnTitleByShowingType<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+Extra/UIButton+Extra.m:12"]
  T6["method:UIView::buttonAutoWidthByFont<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIView/UIView+AutoSelfAdaptionSize/UIView+AutoSelfAdaptionSize.m:33"]
  S6 -->|calls| T6
  S7["method:UIButton::initByTitle<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:91"]
  ...
  S7 -->|calls| T7
  S8["method:UIButton::initByAttributedString<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:101"]
  ...
  S8 -->|calls| T8
  S9["method:UIButton::initByNormalImage<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:111"]
  ...
  S9 -->|calls| T9
  S10["method:UIButton::initByBackgroundImage<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:121"]
  ...
  S10 -->|calls| T10
  S11["method:UIButton::initByTitles<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:132"]
  ...
  S11 -->|calls| T11
  S12["method:UIButton::initByAttributedStrings<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:144"]
  ...
  S12 -->|calls| T12
  S13["method:UIButton::initByTitle_font<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:157"]
  ...
  S13 -->|calls| T13
  S14["method:UIButton::initByStyle1<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:169"]
  ...
  S14 -->|calls| T14
  S15["method:UIButton::initByStyle2<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:183"]
  ...
  S15 -->|calls| T15
  S16["method:UIButton::initByStyle3<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:203"]
  ...
  S16 -->|calls| T16
  S17["method:UIButton::initByStyle4<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:219"]
  ...
  S17 -->|calls| T17
  S18["method:UIButton::initByStyle5<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:239"]
  ...
  S18 -->|calls| T18
  S19["method:UIButton::jobsInit<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:307"]
  ...
  S19 -->|calls| T19
  S20["method:UIButton::initByViewModel<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:316"]
  ...
  S20 -->|calls| T20
  S21["method:UIButton::initByViewModel<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:316"]
  ...
  S21 -->|calls| T21
  S22["method:UIButton::initByButtonModel<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:360"]
  ...
  S22 -->|calls| T22
  S23["method:UIButton::initByButtonModel<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:360"]
  ...
  S23 -->|calls| T23
  S24["method:UIButton::initByTextModel<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:404"]
  T24["function:JobsWidth<br/>JobsByPods/JobsOCDefs@Pods/Core/MacroDef_Others/MacroDef_Size.h:377"]
  S24 -->|calls| T24
  S25["method:UIButton::initByTextModel<br/>JobsByPods/JobsNavBar@Pods/Support/UIKit/UIButton/UIButton+SimplyMake/UIButton+SimplyMake.m:404"]
