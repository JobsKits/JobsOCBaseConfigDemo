...
#import <JobsModel/NSCoder+Extra.h>
...
+(BOOL)supportsSecureCoding{
    return (((JobsRetBOOLByVoidBlock (*)(__typeof__(self), SEL))JobsBlockClassMethodIMP(FMDoorModel.class, @selector(jobsSupportsSecureCoding)))(self, @selector(jobsSupportsSecureCoding)))();
}
