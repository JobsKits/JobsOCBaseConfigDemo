...
#import <JobsModel/NSMutableSet+Extra.h>
...
+(BOOL)supportsSecureCoding{
    return (((JobsRetBOOLByVoidBlock (*)(__typeof__(self), SEL))JobsBlockClassMethodIMP(JobsUserModel.class, @selector(jobsSupportsSecureCoding)))(self, @selector(jobsSupportsSecureCoding)))();
}
