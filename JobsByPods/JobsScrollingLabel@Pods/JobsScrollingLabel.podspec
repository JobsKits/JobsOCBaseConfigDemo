...
JobsScrollingLabel keeps UILabel as the public API while rendering overflowing
...
motion, preserves attributed text, and is driven by JobsOCTimer.
  DESC
  spec.homepage         = 'https://example.local/JobsScrollingLabel'
  ...
  spec.header_dir = 'JobsScrollingLabel'

  JobsPodspecKitForJobsScrollingLabel.apply_standard_exclude_files(spec)
  JobsPodspecKitForJobsScrollingLabel.apply_standard_xcconfig(spec)
end
