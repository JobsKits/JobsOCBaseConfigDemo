...
#import <JobsMakes/NSString+Extra.h>
...
NS_INLINE __kindof MFMessageComposeViewController *_Nonnull
jobsMakeMFMessageComposeVC(jobsByMFMessageComposeVCBlock _Nonnull block){
    MFMessageComposeViewController *data = MFMessageComposeViewController.alloc.init;
    if (block) block(data);
    return data;
}

NS_INLINE __kindof MFMailComposeViewController *_Nonnull
jobsMakeMFMailComposeVC(jobsByMFMailComposeVCBlock _Nonnull block){
    MFMailComposeViewController *data = MFMailComposeViewController.alloc.init;
    if (block) block(data);
    return data;
}
