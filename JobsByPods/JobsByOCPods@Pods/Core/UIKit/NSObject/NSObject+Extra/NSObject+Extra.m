...
-(__kindof UICollectionViewFlowLayout *)verticalLayout{
    return (((JobsRetCollectionViewFlowLayoutByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(NSObject.class, @selector(jobsVerticalLayout)))(self, @selector(jobsVerticalLayout)))();
}

-(JobsRetCollectionViewFlowLayoutByVoidBlock _Nonnull)jobsVerticalLayout{
    @jobs_weakify(self)
    return ^__kindof UICollectionViewFlowLayout *_Nonnull{
        @jobs_strongify(self)
        if (!self) return nil;
...
-(__kindof UICollectionViewFlowLayout *)horizontalLayout{
    return (((JobsRetCollectionViewFlowLayoutByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(NSObject.class, @selector(jobsHorizontalLayout)))(self, @selector(jobsHorizontalLayout)))();
}
...
@implementation PHAssetCreationRequest (JobsLocalPropertyDSLAutogen_95727b1c38)
-(JobsRetPHAssetCreationRequestByNSDateBlock _Nonnull)byCreationDate{
    @jobs_weakify(self)
