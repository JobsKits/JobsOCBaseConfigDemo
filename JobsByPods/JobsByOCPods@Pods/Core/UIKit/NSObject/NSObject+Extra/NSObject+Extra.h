...
#import <JobsByOCPods/NSDictionary+Extra.h>
...
#import <JobsByOCPods/UICollectionViewFlowLayout+Extra.h>
...
NS_INLINE NSObject *_Nullable JobsByOCPodsIDToObject(id _Nullable data){
...
@interface NSObject (JobsByOCPodsExtra)
<
AppToolsProtocol
,BaseProtocol
