...
#ifndef JOBS_HEADER_GUARD_NSSTRING_PATH_1D5756FEBC
#define JOBS_HEADER_GUARD_NSSTRING_PATH_1D5756FEBC
...
@interface NSString (JobsBaseUIPath)
...
#endif /* JOBS_HEADER_GUARD_NSSTRING_PATH_1D5756FEBC */
