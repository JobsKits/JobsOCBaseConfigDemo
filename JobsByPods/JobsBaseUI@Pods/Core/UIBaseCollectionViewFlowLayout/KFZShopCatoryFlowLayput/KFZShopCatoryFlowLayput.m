...
- (void)prepareLayout{
    (((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(KFZShopCatoryFlowLayput.class, @selector(jobsPrepareLayout)))(self, @selector(jobsPrepareLayout)))();
}
