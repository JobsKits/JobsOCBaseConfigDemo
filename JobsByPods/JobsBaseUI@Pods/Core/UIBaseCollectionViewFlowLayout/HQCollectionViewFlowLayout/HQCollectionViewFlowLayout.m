...
- (NSArray *) layoutAttributesForElementsInRect:(CGRect)rect{
    JobsRetNSArrayByCGRectBlock action = ((JobsRetNSArrayByCGRectBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(HQCollectionViewFlowLayout.class, @selector(jobsLayoutAttributesForElementsInRect)))(self, @selector(jobsLayoutAttributesForElementsInRect));
        ...
        for (UICollectionViewLayoutAttributes *attributes in superArray) {
            ...
            if ([attributes.representedElementKind isEqualToString:UICollectionElementKindSectionHeader]){
                ...
                if (numberOfItemsInSection > 0){
                    ...
                    firstItemAttributes.byFrame(CGRectMake(0, y, 0, 0));
...
- (BOOL) shouldInvalidateLayoutForBoundsChange:(CGRect)newBound{
    return ((((JobsRetBOOLByFrameBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(HQCollectionViewFlowLayout.class, @selector(shouldInvalidateLayoutForBoundsChange)))(self, @selector(shouldInvalidateLayoutForBoundsChange))))(newBound);
}
-(JobsRetBOOLByFrameBlock _Nonnull)shouldInvalidateLayoutForBoundsChange{
    @jobs_weakify(self)
    return ^BOOL(CGRect newBound){
        @jobs_strongify(self)
