...
#import <JobsBasePopupView/NSString+Menu.h>
#import <JobsBasePopupView/NSObject+Notification.h>

@interface JobsBasePopupTextView ()
...
-(void)layoutSubviews{
    jobsByVoidBlock action = ((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsBasePopupTextView.class, @selector(jobsLayoutSubviews)))(self, @selector(jobsLayoutSubviews));
    if (action) action();
}
...
-(BOOL)canBecomeFirstResponder {
    return (((JobsRetBOOLByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsBasePopupTextView.class, @selector(jobsCanBecomeFirstResponder)))(self, @selector(jobsCanBecomeFirstResponder)))();
}
