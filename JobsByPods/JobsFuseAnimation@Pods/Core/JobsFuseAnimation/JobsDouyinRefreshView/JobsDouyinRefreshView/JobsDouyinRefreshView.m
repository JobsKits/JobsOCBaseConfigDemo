...
@interface JobsDouyinRefreshView (JobsPropertyDSLSetterAutogen_1e3654ff62)
...
@interface CAAnimationGroup (JobsLocalPropertyDSLAutogen_1e3654ff62)
...
@implementation CAAnimationGroup (JobsLocalPropertyDSLAutogen_1e3654ff62)
-(JobsRetCAAnimationGroupByNSArrayCAAnimationBlock _Nonnull)byAnimations{
    @jobs_weakify(self)
