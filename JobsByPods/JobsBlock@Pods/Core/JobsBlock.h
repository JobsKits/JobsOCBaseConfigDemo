...
typedef __kindof JobsTextField *_Nonnull(^JobsReturnJobsTextFieldByUITextFieldBlock)(__kindof UITextField *_Nullable textField);
typedef __kindof JobsTextField *_Nonnull(^JobsReturnJobsTextFieldByTextFieldConfigBlock)(jobsByTextFieldBlock _Nullable config);
typedef void(^jobsByHQTextFieldBlock)(__kindof HQTextField *_Nullable textField);
typedef __kindof CJTextField *_Nullable(^JobsReturnCJTextFieldByDeleteDelegateBlock)(id<CJTextFieldDeleteDelegate> _Nullable delegate);
typedef __kindof HQTextField *_Nullable(^JobsReturnHQTextFieldByVoidBlock)(void);
typedef __kindof ZYTextField *_Nullable(^JobsReturnZYTextFieldByCGFloatBlock)(CGFloat data);
typedef __kindof ZYTextField *_Nullable(^JobsReturnZYTextFieldByBOOLBlock)(BOOL data);
typedef __kindof ZYTextField *_Nullable(^JobsReturnZYTextFieldByCorBlock)(UIColor *_Nullable cor);
typedef __kindof ZYTextField *_Nullable(^JobsReturnZYTextFieldByFontBlock)(UIFont *_Nullable font);
typedef __kindof ZYTextField *_Nullable(^JobsReturnZYTextFieldByCGRectBlock)(CGRect data);
typedef __kindof ZYTextField *_Nullable(^JobsReturnZYTextFieldByNSIntegerBlock)(NSInteger data);
typedef __kindof JobsMagicTextField *_Nullable(^JobsReturnMagicTextFieldByBOOLBlock)(BOOL data);
typedef __kindof JobsMagicTextField *_Nullable(^JobsReturnMagicTextFieldByCorBlock)(UIColor *_Nullable cor);
typedef __kindof JobsMagicTextField *_Nullable(^JobsReturnMagicTextFieldByFontBlock)(UIFont *_Nullable font);
typedef __kindof JobsMagicTextField *_Nullable(^JobsReturnMagicTextFieldByCGFloatBlock)(CGFloat data);
typedef __kindof JobsMagicTextField *_Nullable(^JobsReturnMagicTextFieldByTimeIntervalBlock)(NSTimeInterval data);
...
typedef __kindof HXPhotoView *_Nullable(^JobsRetHXPhotoViewByManagerBlock)(__kindof HXPhotoManager *_Nullable data);
