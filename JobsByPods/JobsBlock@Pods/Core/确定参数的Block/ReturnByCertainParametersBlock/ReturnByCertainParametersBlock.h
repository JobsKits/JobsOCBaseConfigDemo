...
#import <MapKit/MapKit.h>                       // 提供 MKCoordinateRegion 等地图结构体 Block 参数类型。
...
typedef Class _Nullable(^JobsRetAppDelegateByNSMutableArrayNSStringBlock)(NSMutableArray <__kindof NSString *>* _Nullable data);
typedef Class _Nullable(^JobsRetFMGameCVCellBySourceTypeBlock)(SourceType data);
typedef __kindof ASButtonNode * _Nullable(^JobsRetASButtonNodeByNSStringBlock)(NSString * _Nullable data);
typedef __kindof ASEditableTextNode * _Nullable(^JobsRetASEditableTextNodeByCGColorRefBlock)(CGColorRef data);
typedef __kindof ASEditableTextNode * _Nullable(^JobsRetASEditableTextNodeByCGFloatBlock)(CGFloat data);
typedef __kindof ASLayoutElementStyle * _Nullable(^JobsRetASLayoutElementStyleByCGSizeBlock)(CGSize data);
typedef __kindof ASMapNode * _Nullable(^JobsRetASMapNodeByBOOLBlock)(BOOL data);
typedef __kindof ASMapNode * _Nullable(^JobsRetASMapNodeByCGFloatBlock)(CGFloat data);
typedef __kindof ASMapNode * _Nullable(^JobsRetASMapNodeByMKCoordinateRegionBlock)(MKCoordinateRegion data);
typedef __kindof ASNetworkImageNode * _Nullable(^JobsRetASNetworkImageNodeByCGFloatBlock)(CGFloat data);
typedef __kindof ASNetworkImageNode * _Nullable(^JobsRetASNetworkImageNodeByNSTimeIntervalBlock)(NSTimeInterval data);
typedef __kindof ASTableNode * _Nullable(^JobsRetASTableNodeByBOOLBlock)(BOOL data);
typedef __kindof ASTableNode * _Nullable(^JobsRetASTableNodeByCGFloatBlock)(CGFloat data);
typedef __kindof ASTableNode * _Nullable(^JobsRetASTableNodeByIDASTableDataSourceBlock)(id<ASTableDataSource> _Nullable data);
typedef __kindof ASTableNode * _Nullable(^JobsRetASTableNodeByIDASTableDelegateBlock)(id<ASTableDelegate> _Nullable data);
typedef __kindof ASVideoNode * _Nullable(^JobsRetASVideoNodeByBOOLBlock)(BOOL data);
typedef __kindof ASVideoNode * _Nullable(^JobsRetASVideoNodeByCGFloatBlock)(CGFloat data);
typedef __kindof ASVideoNode * _Nullable(^JobsRetASVideoNodeByNSStringBlock)(NSString * _Nullable data);
typedef __kindof ASVideoNode * _Nullable(^JobsRetASVideoNodeByNSURLBlock)(NSURL * _Nullable data);
typedef __kindof ASVideoNode * _Nullable(^JobsRetASVideoNodeByUIColorBlock)(UIColor * _Nullable data);
typedef __kindof AVAssetImageGenerator * _Nullable(^JobsRetAVAssetImageGeneratorByBOOLBlock)(BOOL data);
...
typedef __kindof CompressStrVC * _Nullable(^JobsRetCompressStrVCByNSStringBlock)(NSString * _Nullable data);
...
typedef __kindof FMHomeMainBizSubView * _Nullable(^JobsRetFMHomeMainBizSubViewByGoodsClassModelBlock)(GoodsClassModel * _Nullable data);
typedef __kindof FMHomeMainBizSubView * _Nullable(^JobsRetFMHomeMainBizSubViewByNSMutableArrayUIButtonModelBlock)(NSMutableArray <UIButtonModel *>* _Nullable data);
typedef __kindof GXCardViewDemoVC * _Nullable(^JobsRetGXCardViewDemoVCByNSIntegerBlock)(NSInteger data);
typedef __kindof GifLoopPlayView * _Nullable(^JobsRetGifLoopPlayViewByBOOLBlock)(BOOL data);
typedef __kindof HAHandleDemoView * _Nullable(^JobsRetHAHandleDemoViewByNSTimerBlock)(NSTimer * _Nullable data);
...
typedef __kindof JXCategoryTimelineCellModel * _Nullable(^JobsRetJXCategoryTimelineCellModelByNSStringBlock)(NSString * _Nullable data);
typedef __kindof JXCategoryTimelineCellModel * _Nullable(^JobsRetJXCategoryTimelineCellModelByUIColorBlock)(UIColor * _Nullable data);
typedef __kindof JXCategoryTimelineCellModel * _Nullable(^JobsRetJXCategoryTimelineCellModelByUIFontBlock)(UIFont * _Nullable data);
typedef __kindof JXCategoryTitleBackgroundCell * _Nullable(^JobsRetJXCategoryTitleBackgroundCellByCALayerBlock)(CALayer * _Nullable data);
typedef __kindof JXCategoryTitleBackgroundCellModel * _Nullable(^JobsRetJXCategoryTitleBackgroundCellModelByCGFloatBlock)(CGFloat data);
typedef __kindof JXCategoryTitleBackgroundCellModel * _Nullable(^JobsRetJXCategoryTitleBackgroundCellModelByUIColorBlock)(UIColor * _Nullable data);
typedef __kindof JXCategoryTitleBackgroundView * _Nullable(^JobsRetJXCategoryTitleBackgroundViewByCGFloatBlock)(CGFloat data);
typedef __kindof JXCategoryTitleBackgroundView * _Nullable(^JobsRetJXCategoryTitleBackgroundViewByUIColorBlock)(UIColor * _Nullable data);
...
typedef __kindof JobsBaseTableViewCell * _Nullable(^JobsRetJobsBaseTableViewCellByUIImageBlock)(UIImage * _Nullable data);
...
typedef __kindof JobsClockView * _Nullable(^JobsRetJobsClockViewByCALayerBlock)(CALayer * _Nullable data);
typedef __kindof JobsClockView * _Nullable(^JobsRetJobsClockViewByCAShapeLayerBlock)(CAShapeLayer * _Nullable data);
typedef __kindof JobsClockView * _Nullable(^JobsRetJobsClockViewByNSArrayUILabelBlock)(NSArray<UILabel *> * _Nullable data);
...
typedef __kindof JobsExcelConfigureViewModel * _Nullable(^JobsRetJobsExcelConfigureViewModelByCGFloatBlock)(CGFloat data);
typedef __kindof JobsExcelConfigureViewModel * _Nullable(^JobsRetJobsExcelConfigureViewModelByNSValueBlock)(NSValue * _Nullable data);
typedef __kindof JobsExcelContentView * _Nullable(^JobsRetJobsExcelContentViewByCGPointBlock)(CGPoint data);
typedef __kindof JobsExcelContentView * _Nullable(^JobsRetJobsExcelContentViewByJobsExcelConfigureViewModelBlock)(JobsExcelConfigureViewModel * _Nullable data);
typedef __kindof JobsExcelLeftListView * _Nullable(^JobsRetJobsExcelLeftListViewByJobsExcelConfigureViewModelBlock)(JobsExcelConfigureViewModel * _Nullable data);
typedef __kindof JobsExcelTopHeadView * _Nullable(^JobsRetJobsExcelTopHeadViewByJobsExcelConfigureViewModelBlock)(JobsExcelConfigureViewModel * _Nullable data);
...
typedef __kindof JobsRightMenuView * _Nullable(^JobsRetJobsRightMenuViewByNSArrayUIButtonBlock)(NSArray <__kindof UIButton*>* _Nullable data);
typedef __kindof JobsScale * _Nullable(^JobsRetJobsScaleByBOOLBlock)(BOOL data);
typedef __kindof JobsScale * _Nullable(^JobsRetJobsScaleByCGFloatBlock)(CGFloat data);
...
typedef __kindof JobsTabBar * _Nullable(^JobsRetJobsTabBarByCGFloatBlock)(CGFloat data);
...
typedef __kindof JobsUploadingProgressView * _Nullable(^JobsRetJobsUploadingProgressViewByCAKeyframeAnimationBlock)(CAKeyframeAnimation * _Nullable data);
...
typedef __kindof JobsWalletCardCollectionViewCell * _Nullable(^JobsRetJobsWalletCardCollectionViewCellByJobsWalletCardModelBlock)(JobsWalletCardModel * _Nullable data);
typedef __kindof JobsWalletCardView * _Nullable(^JobsRetJobsWalletCardViewByNSArrayJobsWalletCardModelBlock)(NSArray<JobsWalletCardModel *> * _Nullable data);
typedef __kindof JobsWalletCollectionViewLayout * _Nullable(^JobsRetJobsWalletCollectionViewLayoutByCGFloatBlock)(CGFloat data);
typedef __kindof JobsWalletCollectionViewLayout * _Nullable(^JobsRetJobsWalletCollectionViewLayoutByCGSizeBlock)(CGSize data);
typedef __kindof JobsWalletCollectionViewLayout * _Nullable(^JobsRetJobsWalletCollectionViewLayoutByJobsWalletCardExpandStyleBlock)(JobsWalletCardExpandStyle data);
...
typedef __kindof LiveChat * _Nullable(^JobsRetLiveChatByNSStringBlock)(NSString * _Nullable data);
typedef __kindof LuckyDiskDemoVC * _Nullable(^JobsRetLuckyDiskDemoVCByNSIntegerBlock)(NSInteger data);
typedef __kindof LuckyDiskDemoVC * _Nullable(^JobsRetLuckyDiskDemoVCByNSTimerBlock)(NSTimer * _Nullable data);
...
typedef __kindof PHCycleView * _Nullable(^JobsRetPHCycleViewByCGFloatBlock)(CGFloat data);
...
typedef __kindof PopListBaseView * _Nullable(^JobsRetPopListBaseViewByNSMutableArrayUIViewModelBlock)(NSMutableArray <__kindof UIViewModel *>* _Nullable data);
...
typedef __kindof RYCuteView * _Nullable(^JobsRetRYCuteViewByBOOLBlock)(BOOL data);
typedef __kindof RYCuteView * _Nullable(^JobsRetRYCuteViewByCGFloatBlock)(CGFloat data);
...
typedef __kindof SlideToUnlockView * _Nullable(^JobsRetSlideToUnlockViewByCGSizeBlock)(CGSize data);
typedef __kindof SlideToUnlockView * _Nullable(^JobsRetSlideToUnlockViewByMASConstraintBlock)(MASConstraint * _Nullable data);
...
typedef __kindof TMSCollectionViewLayout * _Nullable(^JobsRetTMSCollectionViewLayoutByBOOLBlock)(BOOL data);
typedef __kindof TMSCollectionViewLayout * _Nullable(^JobsRetTMSCollectionViewLayoutByNSIndexPathBlock)(NSIndexPath * _Nullable data);
...
typedef __kindof TextureDemoVC * _Nullable(^JobsRetTextureDemoVCByBOOLBlock)(BOOL data);
...
typedef __kindof UIGestureRecognizer * _Nullable(^JobsRetUIGestureRecognizerByRACGestureRecognizerActionHandlerBlock)(RACGestureRecognizerActionHandler * _Nullable data);
typedef __kindof UIGestureRecognizer * _Nullable(^JobsRetUIGestureRecognizerByRACSubjectBlock)(RACSubject * _Nullable data);
...
typedef __kindof UITabBar * _Nullable(^JobsRetUITabBarByNSUIntegerBlock)(NSUInteger data);
...
typedef __kindof XDTextBtnView * _Nullable(^JobsRetXDTextBtnViewByNSIntegerBlock)(NSInteger data);
...
typedef SlideToUnlockView * _Nullable(^JobsRetSlideToUnlockViewByjobsByVoidBlockBlock)(jobsByVoidBlock data);
...
typedef __kindof JobsNavigationTransitionMgr *_Nullable(^JobsRetNavigationTransitionMgrByVCBlock)(UIViewController *_Nullable data);
typedef __kindof JobsNavigationTransitionMgr *_Nullable(^JobsRetNavigationTransitionMgrByDirectionBlock)(JobsTransitionDirection data);
typedef __kindof JobsNavigationTransitionMgr *_Nullable(^JobsRetNavigationTransitionMgrByInteractiveTransitionBlock)(UIPercentDrivenInteractiveTransition *_Nullable data);
typedef __kindof JobsNavigationTransitionMgr *_Nullable(^JobsRetNavigationTransitionMgrByComingStyleBlock)(ComingStyle data);
