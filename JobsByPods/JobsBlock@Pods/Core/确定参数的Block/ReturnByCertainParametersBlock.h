...
typedef __kindof CALayer *_Nullable(^JobsRetCALayerByUIColorBlock)(UIColor *_Nullable data);
...
typedef __kindof CAShapeLayer *_Nullable(^JobsRetCAShapeLayerByUIColorBlock)(UIColor *_Nullable data);
...
/// UIView + UIGestureRecognizer Action DSL
...
#pragma mark —— JobsOCDSL 系统 API 补齐
...
#pragma mark —— JobsOCDSL FSCalendar DSL 补齐
#pragma mark —— FSCalendar DSL：FSCalendar
...
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarByAllowsSelectionBlock)(BOOL data);
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarByAllowsMultipleSelectionBlock)(BOOL data);
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarByAdjustsBoundingRectWhenChangingMonthsBlock)(BOOL data);
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarByPagingEnabledBlock)(BOOL data);
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarByScrollEnabledBlock)(BOOL data);
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarByRowHeightBlock)(CGFloat data);
typedef FSCalendarAppearance * _Nullable(^JobsRetFSCalendarByGetAppearanceBlock)(void);
typedef NSDate * _Nullable(^JobsRetFSCalendarByGetMinimumDateBlock)(void);
typedef NSDate * _Nullable(^JobsRetFSCalendarByGetMaximumDateBlock)(void);
typedef NSDate * _Nullable(^JobsRetFSCalendarByGetSelectedDateBlock)(void);
typedef NSArray<NSDate *> * _Nullable(^JobsRetFSCalendarByGetSelectedDatesBlock)(void);
typedef FSCalendarCollectionView * _Nullable(^JobsRetFSCalendarByGetCollectionViewBlock)(void);
typedef FSCalendarCollectionViewLayout * _Nullable(^JobsRetFSCalendarByGetCollectionViewLayoutBlock)(void);
typedef FSCalendarTransitionCoordinator * _Nullable(^JobsRetFSCalendarByGetTransitionCoordinatorBlock)(void);
typedef FSCalendarCalculator * _Nullable(^JobsRetFSCalendarByGetCalculatorBlock)(void);
typedef BOOL(^JobsRetFSCalendarByGetFloatingModeBlock)(void);
typedef NSArray * _Nullable(^JobsRetFSCalendarByGetVisibleStickyHeadersBlock)(void);
typedef CGFloat(^JobsRetFSCalendarByGetPreferredHeaderHeightBlock)(void);
typedef CGFloat(^JobsRetFSCalendarByGetPreferredWeekdayHeightBlock)(void);
typedef NSCalendar * _Nullable(^JobsRetFSCalendarByGetGregorianBlock)(void);
typedef NSDateFormatter * _Nullable(^JobsRetFSCalendarByGetFormatterBlock)(void);
typedef UIView * _Nullable(^JobsRetFSCalendarByGetContentViewBlock)(void);
typedef UIView * _Nullable(^JobsRetFSCalendarByGetDaysContainerBlock)(void);
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarByNeedsAdjustingViewFrameBlock)(BOOL data);
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarByReloadDataBlock)(void);
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarBySelectDateBlock)(NSDate * _Nullable data);
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarByDeselectDateBlock)(NSDate * _Nullable data);
...
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarByHandleScopeGestureBlock)(UIPanGestureRecognizer * _Nullable data);
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarByAdjustMonthPositionBlock)(void);
typedef __kindof FSCalendar * _Nullable(^JobsRetFSCalendarByConfigureAppearanceBlock)(void);
#pragma mark —— FSCalendar DSL：FSCalendarAppearance
...
typedef NSDictionary * _Nullable(^JobsRetFSCalendarAppearanceByGetBackgroundColorsBlock)(void);
typedef NSDictionary * _Nullable(^JobsRetFSCalendarAppearanceByGetTitleColorsBlock)(void);
typedef NSDictionary * _Nullable(^JobsRetFSCalendarAppearanceByGetSubtitleColorsBlock)(void);
typedef NSDictionary * _Nullable(^JobsRetFSCalendarAppearanceByGetBorderColorsBlock)(void);
#pragma mark —— FSCalendar DSL：FSCalendarCell
...
#pragma mark —— FSCalendar DSL：FSCalendarEventIndicator
...
#pragma mark —— FSCalendar DSL：FSCalendarCollectionViewLayout
...
#pragma mark —— FSCalendar DSL：FSCalendarCalculator
typedef __kindof FSCalendarCalculator * _Nullable(^JobsRetFSCalendarCalculatorByCalendarBlock)(FSCalendar * _Nullable data);
typedef NSInteger(^JobsRetFSCalendarCalculatorByGetNumberOfSectionsBlock)(void);
typedef NSDate * _Nullable(^JobsRetFSCalendarCalculatorBySafeDateForDateBlock)(NSDate * _Nullable data);
typedef NSDate * _Nullable(^JobsRetFSCalendarCalculatorByDateForIndexPathBlock)(NSIndexPath * _Nullable data);
typedef NSIndexPath * _Nullable(^JobsRetFSCalendarCalculatorByIndexPathForDateBlock)(NSDate * _Nullable data);
typedef NSDate * _Nullable(^JobsRetFSCalendarCalculatorByPageForSectionBlock)(NSInteger data);
typedef NSDate * _Nullable(^JobsRetFSCalendarCalculatorByWeekForSectionBlock)(NSInteger data);
typedef NSDate * _Nullable(^JobsRetFSCalendarCalculatorByMonthForSectionBlock)(NSInteger data);
typedef NSDate * _Nullable(^JobsRetFSCalendarCalculatorByMonthHeadForSectionBlock)(NSInteger data);
typedef NSInteger(^JobsRetFSCalendarCalculatorByNumberOfHeadPlaceholdersForMonthBlock)(NSDate * _Nullable data);
typedef NSInteger(^JobsRetFSCalendarCalculatorByNumberOfRowsInMonthBlock)(NSDate * _Nullable data);
typedef NSInteger(^JobsRetFSCalendarCalculatorByNumberOfRowsInSectionBlock)(NSInteger data);
...
#pragma mark —— FSCalendar DSL：FSCalendarDelegationProxy
...
#pragma mark —— FSCalendar DSL：UIView
typedef __kindof UIView * _Nullable(^JobsRetUIViewByFs_widthBlock)(CGFloat data);
typedef __kindof UIView * _Nullable(^JobsRetUIViewByFs_heightBlock)(CGFloat data);
typedef __kindof UIView * _Nullable(^JobsRetUIViewByFs_topBlock)(CGFloat data);
typedef __kindof UIView * _Nullable(^JobsRetUIViewByFs_leftBlock)(CGFloat data);
typedef __kindof UIView * _Nullable(^JobsRetUIViewByFs_bottomBlock)(CGFloat data);
typedef __kindof UIView * _Nullable(^JobsRetUIViewByFs_rightBlock)(CGFloat data);
#pragma mark —— FSCalendar DSL：CALayer
typedef __kindof CALayer * _Nullable(^JobsRetCALayerByFs_widthBlock)(CGFloat data);
typedef __kindof CALayer * _Nullable(^JobsRetCALayerByFs_heightBlock)(CGFloat data);
typedef __kindof CALayer * _Nullable(^JobsRetCALayerByFs_topBlock)(CGFloat data);
typedef __kindof CALayer * _Nullable(^JobsRetCALayerByFs_leftBlock)(CGFloat data);
typedef __kindof CALayer * _Nullable(^JobsRetCALayerByFs_bottomBlock)(CGFloat data);
typedef __kindof CALayer * _Nullable(^JobsRetCALayerByFs_rightBlock)(CGFloat data);
#pragma mark —— FSCalendar DSL：NSCalendar
typedef NSDate * _Nullable(^JobsRetNSCalendarByFs_firstDayOfMonthBlock)(NSDate * _Nullable data);
typedef NSDate * _Nullable(^JobsRetNSCalendarByFs_lastDayOfMonthBlock)(NSDate * _Nullable data);
typedef NSDate * _Nullable(^JobsRetNSCalendarByFs_firstDayOfWeekBlock)(NSDate * _Nullable data);
typedef NSDate * _Nullable(^JobsRetNSCalendarByFs_lastDayOfWeekBlock)(NSDate * _Nullable data);
typedef NSDate * _Nullable(^JobsRetNSCalendarByFs_middleDayOfWeekBlock)(NSDate * _Nullable data);
typedef NSInteger(^JobsRetNSCalendarByFs_numberOfDaysInMonthBlock)(NSDate * _Nullable data);
#pragma mark —— FSCalendar DSL：NSMapTable
typedef id _Nullable(^JobsRetNSMapTableByObjectForKeyedSubscriptBlock)(id<NSCopying> _Nullable data);
#pragma mark —— FSCalendar DSL：NSCache
typedef id _Nullable(^JobsRetNSCacheByObjectForKeyedSubscriptBlock)(id<NSCopying> _Nullable data);
#pragma mark —— FSCalendar DSL：NSObject
typedef id _Nullable(^JobsRetNSObjectByFs_variableForKeyBlock)(NSString * _Nullable data);
#pragma mark —— FSCalendar DSL：FSCalendarHeaderView
...
typedef __kindof FSCalendarHeaderView * _Nullable(^JobsRetFSCalendarHeaderViewByReloadDataBlock)(void);
typedef __kindof FSCalendarHeaderView * _Nullable(^JobsRetFSCalendarHeaderViewByConfigureAppearanceBlock)(void);
#pragma mark —— FSCalendar DSL：FSCalendarHeaderCell
...
#pragma mark —— FSCalendar DSL：FSCalendarHeaderTouchDeliver
...
#pragma mark —— FSCalendar DSL：FSCalendarStickyHeader
...
#pragma mark —— FSCalendar DSL：FSCalendarTransitionCoordinator
...
typedef NSInteger(^JobsRetFSCalendarTransitionCoordinatorByGetRepresentingScopeBlock)(void);
...
#pragma mark —— FSCalendar DSL：FSCalendarTransitionAttributes
...
#pragma mark —— FSCalendar DSL：FSCalendarWeekdayView
typedef NSArray<UILabel *> * _Nullable(^JobsRetFSCalendarWeekdayViewByGetWeekdayLabelsBlock)(void);
...
#pragma mark —— ReactiveObjC / RAC DSL
typedef id _Nullable(^JobsRetIDByNSErrorPointerBlock)(NSError *_Nullable *_Nullable errorPtr);
typedef id _Nullable(^JobsRetIDByRACErrorPointerBlock)(NSError *_Nullable *_Nullable errorPtr);
typedef id _Nullable(^JobsRetIDByIDNSErrorPointerBlock)(id _Nullable value, NSError *_Nullable *_Nullable errorPtr);
typedef BOOL(^JobsRetBOOLByIDNSErrorPointerBlock)(id _Nullable value, NSError *_Nullable *_Nullable errorPtr);
typedef id _Nullable(^JobsRetIDByIDAndIDBlock)(id _Nullable data, id _Nullable data2);
typedef id _Nullable(^JobsRetIDByIDIDNSUIntegerBlock)(id _Nullable data, id _Nullable data2, NSUInteger index);
typedef BOOL(^JobsRetBOOLByRACValueBlock)(id _Nullable value);
...
typedef __kindof RACSignal *_Nullable(^JobsRetRACSignalByRACNextBlock)(jobsByRACNextBlock _Nullable block);
typedef __kindof RACSignal *_Nullable(^JobsRetRACSignalByRACErrorBlock)(jobsByRACErrorBlock _Nullable block);
typedef __kindof RACSignal *_Nullable(^JobsRetRACSignalByRACCompletedBlock)(jobsByRACCompletedBlock _Nullable block);
...
typedef __kindof RACSignal *_Nullable(^JobsRACSignalBindResultBlock)(id _Nullable value, BOOL *_Nullable stop);
...
typedef __kindof RACSignal *_Nullable(^JobsRetRACSignalByRACBoolPredicateBlock)(JobsRetBOOLByRACValueBlock _Nullable block);
...
typedef __kindof RACDisposable *_Nullable(^JobsRetRACDisposableByRACNextBlock)(jobsByRACNextBlock _Nullable block);
typedef __kindof RACDisposable *_Nullable(^JobsRetRACDisposableByRACErrorBlock)(jobsByRACErrorBlock _Nullable block);
typedef __kindof RACDisposable *_Nullable(^JobsRetRACDisposableByRACCompletedBlock)(jobsByRACCompletedBlock _Nullable block);
...
typedef __kindof RACSequence *_Nullable(^JobsRetRACSequenceByRACBoolPredicateBlock)(JobsRetBOOLByRACValueBlock _Nullable block);
...
typedef __kindof RACSequence *_Nullable(^JobsRACSequenceBindResultBlock)(id _Nullable value, BOOL *_Nullable stop);
...
typedef BOOL(^JobsRetBOOLByRACBoolPredicateBlock)(JobsRetBOOLByRACValueBlock _Nullable block);
typedef id _Nullable(^JobsRetIDByRACBoolPredicateBlock)(JobsRetBOOLByRACValueBlock _Nullable block);
...
typedef id _Nullable(^JobsRetIDByNSUIntegerBlock)(NSUInteger index);
