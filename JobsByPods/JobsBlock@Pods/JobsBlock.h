...
typedef __kindof CountdownView *_Nullable(^JobsRetCountdownViewByNSIntegerBlock)(NSInteger time);
typedef __kindof XLChannelView *_Nullable(^JobsRetXLChannelViewByCollectionViewBlock)(UICollectionView *_Nullable collectionView);
typedef __kindof XLChannelHeader *_Nullable(^JobsRetXLChannelHeaderByLabelBlock)(UILabel *_Nullable label);
...
typedef __kindof GXCardView *_Nullable(^JobsRetGXCardViewByStrBlock)(NSString *_Nullable identifier);
...
typedef __kindof TBCityIconInfo *_Nullable(^JobsRetTBCityIconInfoByStrBlock)(NSString *_Nullable string);
typedef __kindof TBCityIconInfo *_Nullable(^JobsRetTBCityIconInfoByNSIntegerBlock)(NSInteger value);
typedef __kindof TBCityIconInfo *_Nullable(^JobsRetTBCityIconInfoByCorBlock)(UIColor *_Nullable color);
typedef __kindof SlideToUnlockView *_Nullable(^JobsRetSlideToUnlockViewByCGFloatBlock)(CGFloat progress);
...
typedef __kindof JobsRightMenuView *_Nullable(^JobsRetJobsRightMenuViewByBOOLBlock)(BOOL value);
typedef __kindof JobsUploadingProgressView *_Nullable(^JobsRetJobsUploadingProgressViewByCorBlock)(UIColor *_Nullable color);
...
typedef __kindof NotifiView *_Nullable(^JobsRetNotifiViewByDicBlock)(NSDictionary *_Nullable dictionary);
typedef __kindof NotifiView *_Nullable(^JobsRetNotifiViewByNSIntegerBlock)(NSInteger value);
typedef __kindof NotifiView *_Nullable(^JobsRetNotifiViewByCGFloatBlock)(CGFloat value);
typedef __kindof NotifiView *_Nullable(^JobsRetNotifiViewByStrBlockBlock)(jobsByStrBlock _Nullable block);
...
typedef __kindof JobsTimerMgr *_Nullable(^JobsRetJobsTimerMgrByStringAndJobsTimerBlock)(NSString *_Nullable identifier,
...
typedef __kindof JobsTimerMgr *_Nullable(^JobsRetJobsTimerMgrByScopedUpsertTimerBlock)(NSString *_Nullable identifier,
...
typedef __kindof WMZBannerView *_Nullable(^JobsRetWMZBannerViewByArrBlock)(NSArray *_Nullable array);
typedef __kindof WMZBannerView *_Nullable(^JobsRetWMZBannerViewByTimerBlock)(NSTimer *_Nullable timer);
typedef __kindof WMZBannerFadeLayout *_Nullable(^JobsRetWMZBannerFadeLayoutByBOOLBlock)(BOOL value);
typedef __kindof WMZBannerFadeLayout *_Nullable(^JobsRetWMZBannerFadeLayoutByCGFloatBlock)(CGFloat value);
