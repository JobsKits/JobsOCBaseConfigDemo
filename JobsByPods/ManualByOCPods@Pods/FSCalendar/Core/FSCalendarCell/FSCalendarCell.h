...
#ifndef JOBS_FSCALENDAR_CORE_FSCALENDARCELL_FSCALENDARCELL_H
#define JOBS_FSCALENDAR_CORE_FSCALENDARCELL_FSCALENDARCELL_H
...
#endif /* JOBS_FSCALENDAR_CORE_FSCALENDARCELL_FSCALENDARCELL_H */
