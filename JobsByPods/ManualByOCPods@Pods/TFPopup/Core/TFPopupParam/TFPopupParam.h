 ...
 */
Prop_strong()id object0;
Prop_strong()id object1;
Prop_strong()id object2;
/* 【全局属性】时间
...
Prop_assign()NSTimeInterval autoDissmissDuration;
 ...
 */
Prop_assign()BOOL disuseBackground;
Prop_strong()UIColor *backgroundColor;
Prop_assign()BOOL backgroundColorClear;
Prop_assign()BOOL disuseBackgroundTouchHide;
Prop_assign()BOOL disuseShowBackgroundAlphaAnimation;
Prop_assign()BOOL disuseHideBackgroundAlphaAnimation;
/* 【全局属性】拖拽控制
 ...
 */
Prop_assign()BOOL dragEnable;
Prop_assign()DragStyle dragStyle;
Prop_assign()BOOL dragBouncesEnable;
Prop_assign()BOOL discernScrollEnable;
Prop_assign()NSUInteger dragAutoDissmissMinDistance;
/* 【全局属性】弹框渐隐动画
 ...
 */
Prop_assign()BOOL disuseShowPopupAlphaAnimation;
Prop_assign()BOOL disuseHidePopupAlphaAnimation;
Prop_assign()BOOL disuseShowPopupFrameAnimation;
Prop_assign()BOOL disuseHidePopupFrameAnimation;
/* 【全局属性】弹框尺寸和区域
 ...
 */
Prop_assign()CGRect popupAreaRect;
Prop_assign()CGSize popupSize;
Prop_assign()CGPoint offset;
Prop_assign()CGRect popOriginFrame;
Prop_assign()CGRect popTargetFrame;
Prop_assign()BOOL keepPopupOriginFrame;
...
/* 【全局属性】属性动画 和 默认缩放动画冲突
 ...
 hideToValue,隐藏动画结束值
 */
Prop_copy()NSString *showKeyPath;
Prop_strong()id showFromValue;
Prop_strong()id showToValue;
Prop_copy()NSString *hideKeyPath;
Prop_strong()id hideFromValue;
Prop_strong()id hideToValue;
/* 【泡泡弹出方式属性】
 basePoint,弹出泡泡基于哪个点
 bubbleDirection,弹出泡泡的方向,八个方向
 */
Prop_assign()CGPoint basePoint;
Prop_assign()PopupDirection bubbleDirection;
/* 【全局属性】遮罩
 ...
 */
Prop_strong()UIBezierPath *maskShowFromPath;
Prop_strong()UIBezierPath *maskShowToPath;
Prop_strong()UIBezierPath *maskHideFromPath;
Prop_strong()UIBezierPath *maskHideToPath;
