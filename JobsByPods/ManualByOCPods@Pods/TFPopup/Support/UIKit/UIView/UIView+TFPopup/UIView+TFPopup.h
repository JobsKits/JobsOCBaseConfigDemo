...
#import <TFPopup/TFPopupParam.h>
#import <TFPopup/TFPopupExtension.h>
#import <TFPopup/TFPopupConst.h>
#import <TFPopup/UIScrollView+TFPopup.h>
...
* state:拖拽手势状态
*/
- (BOOL)tf_popupViewDidDragSlide:(UIView *)popup
                 distancePercent:(CGFloat)percent
                        distance:(CGFloat)distance
                           state:(UIGestureRecognizerState)state;
@end

@interface UIView (TFPopup)
<
TFPopupDataSource
,TFPopupDelegate
,TFPopupBackgroundDelegate
,CAAnimationDelegate
>
Prop_weak()UIView *inView;//弹框的容器视图
Prop_copy()NSString *identifier;//标示符，用于在弹出池里查找弹出的view
...
-(void)tf_hide:(jobsByVoidBlock)completion;
//手动控制弹框移除
-(void)tf_remove;
...
Prop_copy()AnimationStartBlock startBlock;
Prop_copy()AnimationStopBlock stopBlock;
