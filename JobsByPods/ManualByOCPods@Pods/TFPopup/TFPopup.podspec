...
support_add_real_directory_subspecs = lambda do |parent_subspec, relative_dir|
  ...
  spec.name         = 'TFPopup'
  spec.version      = '1.4.4'
  spec.summary      = 'A powerful pop-up tool'
  spec.description  = <<-DESC
TFPopup is a powerful pop-up tool for iOS.
  DESC

  spec.homepage     = 'https://github.com/shmxybfq/TFPopup'
  spec.license      = { :type => 'MIT', :file => 'LICENSE' }
  spec.author       = { 'ZTF' => '927141965@qq.com' }
  spec.social_media_url = 'http://www.jianshu.com/u/8c1cc9143ec6'
  ...
  spec.source_files        = 'TFPopup.h'
  spec.public_header_files = 'TFPopup.h'
  ...
  spec.subspec 'Core' do |ss|
    ...
    ss.dependency 'TFPopup/Support/UIKit'
  ...
  spec.user_target_xcconfig = {
    'HEADER_SEARCH_PATHS' => '$(inherited) "$(PODS_ROOT)/Headers/Public/TFPopup/**"',
    'CLANG_ALLOW_NON_MODULAR_INCLUDES_IN_FRAMEWORK_MODULES' => 'YES'
  }
end
