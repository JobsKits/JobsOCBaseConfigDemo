...
Prop_strong(class,readonly)TKPermissionLocationAlways *shared;
...
-(void)jumpSetting{
    [TKPermissionPublic alertPromptTips:@"访问位置时需要您提供权限，去设置！".tr];
}

-(void)alertAction{
    [TKPermissionPublic alertTips:@"请先到\"隐私\"中，开启定位服务！".tr];
}
