...
support_add_real_directory_subspecs = lambda do |parent_subspec, relative_dir|
  ...
  spec.name             = 'XYColorOC'
  spec.version          = '1.1.2'
  spec.summary          = 'An Objective-C only dark mode color helper for UIKit and CALayer.'
  spec.description      = <<-DESC
    Objective-C only fork of XYColorOC. It keeps the umbrella header
    XYColorOC.h so consumers can import <XYColorOC/XYColorOC.h>.
  DESC

  spec.homepage         = 'https://github.com/RayJiang16/XYColor'
  spec.license          = { :type => 'MIT', :file => 'LICENSE' }
  spec.author           = { 'RayJiang' => '1184731421@qq.com' }
  spec.source           = { :git => 'https://github.com/RayJiang16/XYColor.git', :tag => spec.version.to_s }
