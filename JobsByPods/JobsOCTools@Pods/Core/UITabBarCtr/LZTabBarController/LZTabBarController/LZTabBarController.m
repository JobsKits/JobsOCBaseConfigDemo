...
@interface LZTabBarController (JobsPropertyDSLSetterAutogen_b1b01f52c2)
...
- (jobsByVoidBlock _Nonnull)setupTabBar {
    ...
    return ^{
        ...
        self.customTabBar.byItems((NSArray<LZTabBarItem *> *)jobsMakeMutArr(^(__kindof NSMutableArray<NSObject *> * _Nullable arr) {
            @jobs_strongify(self)
