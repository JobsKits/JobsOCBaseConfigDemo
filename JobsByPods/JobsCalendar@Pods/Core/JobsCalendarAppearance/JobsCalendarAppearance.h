...
#ifndef JOBS_HEADER_GUARD_JOBS_CALENDAR_APPEARANCE
#define JOBS_HEADER_GUARD_JOBS_CALENDAR_APPEARANCE

#import "JobsCalendarDefines.h"

NS_ASSUME_NONNULL_BEGIN

@interface JobsCalendarAppearance : NSObject
...
Prop_assign()JobsCalendarCaseOptions caseOptions;
...
#endif /* JOBS_HEADER_GUARD_JOBS_CALENDAR_APPEARANCE */
