...
-(JobsReturnViewByViewAndMasonryConstraintsBlocks _Nonnull)byMakeConstraints{
    @jobs_weakify(self)
...
-(JobsReturnViewByViewAndMasonryConstraintsBlocks _Nonnull)byUpdateConstraints{
    @jobs_weakify(self)
    return ^__kindof UIView *_Nullable(__kindof UIView *_Nullable subView,jobsByMASConstraintMakerBlock _Nullable block){
        @jobs_strongify(self)
        if(!subView) return nil;
...
-(JobsReturnViewByViewAndMasonryConstraintsBlocks _Nonnull)byUpdate{
    @jobs_weakify(self)
    return ^__kindof UIView *_Nullable(__kindof UIView *_Nullable subView,jobsByMASConstraintMakerBlock _Nullable block){
        @jobs_strongify(self)
...
-(JobsReturnViewByViewAndMasonryConstraintsBlocks _Nonnull)byRemakes{
    @jobs_weakify(self)
    return ^__kindof UIView *_Nullable(__kindof UIView *_Nullable subView,jobsByMASConstraintMakerBlock _Nullable block){
        @jobs_strongify(self)
