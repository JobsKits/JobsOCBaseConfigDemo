...
-(JobsRetIDBySuperviewMasonryBlock _Nonnull)byAddTo{
    @jobs_weakify(self)
...
-(JobsRetIDByMasonryConstraintsBlock _Nonnull)byOn{
    @jobs_weakify(self)
...
-(JobsRetIDByMasonryConstraintsBlock _Nonnull)byUpdate{
    @jobs_weakify(self)
    return ^__kindof UIView *_Nullable(jobsByMASConstraintMakerBlock _Nullable block){
        @jobs_strongify(self)
        if (block){
...
-(JobsRetIDByMasonryConstraintsBlock _Nonnull)byRemake{
    @jobs_weakify(self)
    return ^__kindof UIView *_Nullable(jobsByMASConstraintMakerBlock _Nullable block){
        @jobs_strongify(self)
        if (block){
