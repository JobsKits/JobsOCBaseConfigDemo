...
PROP_NSUInteger(screenEdgePanGREdges, ScreenEdgePanGREdges)
...
-(JobsRetViewByUIRectEdgeBlock)byScreenEdgePanGREdges{
    ...
    return ^__kindof UIView *_Nullable(UIRectEdge data){
        @jobs_strongify(self)
        self.screenEdgePanGREdges = data;
        return self;
    };
}

#pragma mark —— Add Gesture DSL
-(JobsRetViewByGestureRecognizer)addGR{
    @jobs_weakify(self)
...
-(JobsRetViewByGestureRecognizer)addGestureRecognizerGR{
    return self.addGR;
}
