...
Prop_copy(readonly)JobsRetControlByVoidBlock byToggleSelected;
Prop_assign(readonly)BOOL jobs_isEnabled;
Prop_assign(readonly)BOOL jobs_isSelected;
Prop_assign(readonly)BOOL jobs_isHighlighted;
Prop_assign(readonly)UIControlState jobs_effectiveState;
