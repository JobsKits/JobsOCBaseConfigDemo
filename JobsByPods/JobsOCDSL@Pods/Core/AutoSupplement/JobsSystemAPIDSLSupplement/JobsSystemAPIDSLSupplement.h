...
-(void)setLargeTitleDisplayMode:(UINavigationItemLargeTitleDisplayMode)data;
...
// JOBS_PROPERTY_DSL_DECLARATION_AUTOGEN_BEGIN AVPlayerLayer
-(JobsRetAVPlayerLayerByAVLayerVideoGravityBlock _Nonnull)byVideoGravity;
// JOBS_PROPERTY_DSL_DECLARATION_AUTOGEN_END AVPlayerLayer
@end
