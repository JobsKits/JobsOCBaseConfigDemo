...
#ifndef JOBS_HEADER_GUARD_CATEXTLAYER_DSL_A6F3C2D1
#define JOBS_HEADER_GUARD_CATEXTLAYER_DSL_A6F3C2D1
...
@interface CATextLayer (JobsChain)
...
#endif /* JOBS_HEADER_GUARD_CATEXTLAYER_DSL_A6F3C2D1 */
