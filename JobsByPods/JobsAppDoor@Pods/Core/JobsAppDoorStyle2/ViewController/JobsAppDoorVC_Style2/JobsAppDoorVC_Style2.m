...
@interface JobsAppDoorVC_Style2 (JobsPropertyDSLSetterAutogen_1b51657327)
...
-(BOOL)jobs_requiresDefaultNavigationBar{
    JobsRetBOOLByVoidBlock action = ((JobsRetBOOLByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsAppDoorVC_Style2.class, @selector(jobsJobs_requiresDefaultNavigationBar)))(self, @selector(jobsJobs_requiresDefaultNavigationBar));
