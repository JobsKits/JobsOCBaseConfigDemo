...
@property(strong,nonatomic)UIView *daysContainer;
@property(strong,nonatomic)FSCalendarCollectionView   *collectionView;
@property(strong,nonatomic)FSCalendarCollectionViewLayout *collectionViewLayout;
...
@property(nonatomic,readonly)FSCalendarOrientation currentCalendarOrientation;
