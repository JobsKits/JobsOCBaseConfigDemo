...
/// 获取存款金额奖励@GET
-(URLManagerModel *)get_promotion_api_client_activity_getObtainDepositBonus;
/// 查询活动信息@GET
-(URLManagerModel *)get_promotion_api_client_activity_queryActivityInfo;
/// 查询用户123存款活动的在途订单数量@GET
-(URLManagerModel *)get_promotion_api_client_activity_queryInTransit123DepositOrdersCount;
/// 会员签到@POST
-(URLManagerModel *)get_promotion_api_client_activity_sign;
/// 首存活动-查询累计流水@GET
