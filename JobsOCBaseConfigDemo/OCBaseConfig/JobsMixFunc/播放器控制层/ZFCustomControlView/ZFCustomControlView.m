...
@interface ZFSliderView (JobsPropertyDSLSetterAutogen_fc9b162a2d)
...
@interface ZFSpeedLoadingView (JobsLocalPropertyDSLAutogen_fc9b162a2d)
...
@interface ZFCustomControlView (JobsPropertyDSLSetterAutogen_fc9b162a2d)
...
- (void)playPauseButtonClickAction:(UIButton *)sender {
    jobsByBtnBlock action = ((jobsByBtnBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(ZFCustomControlView.class, @selector(jobsPlayPauseButtonClickAction)))(self, @selector(jobsPlayPauseButtonClickAction));
    if (action) action(sender);
}

-(jobsByBtnBlock _Nonnull)jobsPlayPauseButtonClickAction{
    @jobs_weakify(self)
...
- (void)fullScreenButtonClickAction:(UIButton *)sender {
    jobsByBtnBlock action = ((jobsByBtnBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(ZFCustomControlView.class, @selector(jobsFullScreenButtonClickAction)))(self, @selector(jobsFullScreenButtonClickAction));
    if (action) action(sender);
}

-(jobsByBtnBlock _Nonnull)jobsFullScreenButtonClickAction{
    @jobs_weakify(self)
    return ^(UIButton * sender){
        @jobs_strongify(self)
        if (!self) return;
...
- (jobsByVoidBlock _Nonnull)playOrPause {
    ...
    return ^{
        @jobs_strongify(self)
        if (!self) return;
        self.playOrPauseBtn.bySelected(!self.playOrPauseBtn.isSelected);
...
@implementation ZFSpeedLoadingView (JobsLocalPropertyDSLAutogen_fc9b162a2d)
-(JobsRetZFSpeedLoadingViewByCGFloatBlock _Nonnull)byZf_centerX{
    @jobs_weakify(self)
