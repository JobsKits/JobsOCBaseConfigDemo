...
// JOBS_PROPERTY_DSL_SETTER_DECLARATION_AUTOGEN_BEGIN JobsAppDoorLoginContentView
@interface JobsAppDoorLoginContentView (JobsPropertyDSLSetterAutogen_1488ef7f61)
-(void)setSendBtnEnableDisposable:(RACCompoundDisposable * _Nullable)data;
@end
// JOBS_PROPERTY_DSL_SETTER_DECLARATION_AUTOGEN_END JobsAppDoorLoginContentView
...
-(void)drawRect:(CGRect)rect{
    jobsByFrameBlock action = ((jobsByFrameBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsAppDoorLoginContentView.class, @selector(jobsDrawRect)))(self, @selector(jobsDrawRect));
...
-(void)layoutSubviews{
    jobsByVoidBlock action = ((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsAppDoorLoginContentView.class, @selector(jobsLayoutSubviews)))(self, @selector(jobsLayoutSubviews));
    if (action) action();
}
...
#pragma mark —— 一些私有化方法
-(JobsRetCGFloatByVoidBlock _Nonnull)loginSideRailWidth{
    @jobs_weakify(self)
    return ^CGFloat{
        @jobs_strongify(self)
...
-(JobsRetCGFloatByVoidBlock _Nonnull)loginFormWidth{
    @jobs_weakify(self)
    return ^CGFloat{
        @jobs_strongify(self)
        if (!self) return (CGFloat){0};
...
-(JobsRetCGFloatByVoidBlock _Nonnull)loginFormCenterX{
    @jobs_weakify(self)
    return ^CGFloat{
        @jobs_strongify(self)
        if (!self) return (CGFloat){0};
...
-(jobsByVoidBlock _Nonnull)refreshLoginLayout{
    @jobs_weakify(self)
    return ^{
        @jobs_strongify(self)
        if (!self) return;
...
-(BaseButton *)toRegisterBtn{
    if (!_toRegisterBtn) {
        ...
        _toRegisterBtn = BaseButton.initByStyleTop(Title12,
                                                   ...
                                                   nil,
                                                   JobsAppDoorImageNamed(@"AppDoorBackLogin") ? : JobsAppDoorImageNamed(@"Lock"),
                                                   JobsWidth(8))
    ...
    if (!_storeCodeBtn) {
        ...
        _storeCodeBtn = BaseButton
            ...
            .onClickBy(^(UIButton *x){
                ...
                x.selected ?
                    x.jobsResetBtnImage(JobsAppDoorImageNamed(@"记住密码")) :
                    x.jobsResetBtnImage(JobsAppDoorImageNamed(@"没有记住密码"));
            }).onLongPressGestureBy(^(id data){
                JobsLog(@"");
            })
    ...
    if (!_findCodeBtn) {
        ...
        _findCodeBtn = BaseButton
            .initByStyle1(Title3,
                          UIFontWeightRegularSize(12),
                          Cor4)
            .jobsResetBtnImage(JobsAppDoorImageNamed(@"AppDoorQuestion") ? : JobsAppDoorImageNamed(@"codeDecode"))
            .onClickBy(^(UIButton *x){
                @jobs_strongify(self)
                if (self.objBlock) self.objBlock(x);
            }).onLongPressGestureBy(^(id data){
...
// JOBS_PROPERTY_DSL_IMPLEMENTATION_AUTOGEN_BEGIN JobsAppDoorLoginContentView
-(JobsRetJobsAppDoorLoginContentViewByRACCompoundDisposableBlock _Nonnull)bySendBtnEnableDisposable{
    @jobs_weakify(self)
    return ^__kindof JobsAppDoorLoginContentView * _Nullable(RACCompoundDisposable * _Nullable data){
        @jobs_strongify(self)
        [self setSendBtnEnableDisposable:data];
        return self;
    };
}
// JOBS_PROPERTY_DSL_IMPLEMENTATION_AUTOGEN_END JobsAppDoorLoginContentView
@end
