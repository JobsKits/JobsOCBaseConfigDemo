...
@interface JobsAppDoorInputViewBaseStyle_4 (JobsPropertyDSLSetterAutogen_7a00f30a17)
...
-(JobsOCGraphicCaptchaView *)captchaView{
    if (!_captchaView) {
        ...
        _captchaView.byConfig(self.graphicCaptchaConfig);
        _captchaView
            .byFont(UIFontWeightSemiboldSize(16))
            .byAlpha(0.9);
        _captchaView.byCaptchaBackgroundColor(JobsWhiteColor);
