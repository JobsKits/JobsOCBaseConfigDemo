...
@interface PHFetchOptions (JobsLocalPropertyDSLAutogen_1110d48ffe)
...
+(JobsRetPHAssetCollectionByNSStringBlock _Nonnull)assetCollectionWithTitle{
    return ^PHAssetCollection *(NSString * title){
        PHFetchOptions *options = jobsMakePHFetchOptions(^(PHFetchOptions *object){});
...
@implementation PHFetchOptions (JobsLocalPropertyDSLAutogen_1110d48ffe)
-(JobsRetPHFetchOptionsByNSPredicateBlock _Nonnull)byPredicate{
    @jobs_weakify(self)
