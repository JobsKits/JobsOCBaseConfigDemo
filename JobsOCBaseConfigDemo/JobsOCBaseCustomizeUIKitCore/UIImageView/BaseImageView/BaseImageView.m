...
-(void)layoutIfNeeded{
    jobsByVoidBlock action = ((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(BaseImageView.class, @selector(jobsLayoutIfNeeded)))(self, @selector(jobsLayoutIfNeeded));
    if (action) action();
}
