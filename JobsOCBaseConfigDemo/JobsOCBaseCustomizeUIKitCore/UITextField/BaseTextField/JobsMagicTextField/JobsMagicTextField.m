        ...
        if (self.placeholdAnimationable) {
            ...
            [UIView animateWithDuration:self.animationTime
                ...
                if (self.attributedPlaceholder && !self.placeholder) {
                    ...
                    self.placeholderAnimationLbl.byTextColor(self.animationColor);
                    self.placeholderAnimationLbl.byFont(self.animationFont);
        ...
        if (self.placeholdAnimationable) {
            ...
            [UIView animateWithDuration:self.animationTime
                ...
                if (self.attributedPlaceholder && !self.placeholder) {
                    ...
                    self.placeholderAnimationLbl.byText(@"".jobsTr());
                    self.placeholderAnimationLbl.byTextColor(self.placeholderColor);
                    self.placeholderAnimationLbl.byFont(self.placeholderFont);
                }
            }];
        }
    };
