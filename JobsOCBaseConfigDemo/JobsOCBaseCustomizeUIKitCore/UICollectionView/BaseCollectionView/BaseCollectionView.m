...
-(void)layoutIfNeeded{
    jobsByVoidBlock action = ((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(BaseCollectionView.class, @selector(jobsLayoutIfNeeded)))(self, @selector(jobsLayoutIfNeeded));
    if (action) action();
}
