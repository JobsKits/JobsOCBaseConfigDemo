...
- (id)objectAtIndex:(NSUInteger)index {
    return ((((JobsRetIDByUIntegerBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(NSMutableDictionary.class, @selector(objectAtIndex)))(self, @selector(objectAtIndex))))(index);
}
