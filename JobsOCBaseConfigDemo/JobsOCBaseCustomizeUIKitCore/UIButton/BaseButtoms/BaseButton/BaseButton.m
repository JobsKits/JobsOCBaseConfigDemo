...
// JOBS_PROPERTY_DSL_SETTER_DECLARATION_AUTOGEN_BEGIN BaseButton
@interface BaseButton (JobsPropertyDSLSetterAutogen_df32ccd68d)
-(void)setSizer:(CGSize)data;
@end
// JOBS_PROPERTY_DSL_SETTER_DECLARATION_AUTOGEN_END BaseButton
...
// JOBS_PROPERTY_DSL_IMPLEMENTATION_AUTOGEN_BEGIN BaseButton
-(JobsRetBaseButtonByCGSizeBlock _Nonnull)bySizer{
    @jobs_weakify(self)
    return ^__kindof BaseButton * _Nullable(CGSize data){
        @jobs_strongify(self)
        [self setSizer:data];
        return self;
    };
}
// JOBS_PROPERTY_DSL_IMPLEMENTATION_AUTOGEN_END BaseButton
@end
