...
-(void)layoutIfNeeded{
    jobsByVoidBlock action = ((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(BaseView.class, @selector(jobsLayoutIfNeeded)))(self, @selector(jobsLayoutIfNeeded));
    if (action) action();
}
