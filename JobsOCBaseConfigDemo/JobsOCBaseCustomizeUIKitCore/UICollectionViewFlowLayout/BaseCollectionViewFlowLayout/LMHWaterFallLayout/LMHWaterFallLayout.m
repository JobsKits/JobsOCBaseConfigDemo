...
/// 初始化
-(void)prepareLayout{
    jobsByVoidBlock action = ((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(LMHWaterFallLayout.class, @selector(jobsPrepareLayout)))(self, @selector(jobsPrepareLayout));
    if (action) action();
}
...
-(CGSize)collectionViewContentSize{
    JobsRetCGSizeByVoidBlock action = ((JobsRetCGSizeByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(LMHWaterFallLayout.class, @selector(jobsCollectionViewContentSize)))(self, @selector(jobsCollectionViewContentSize));
