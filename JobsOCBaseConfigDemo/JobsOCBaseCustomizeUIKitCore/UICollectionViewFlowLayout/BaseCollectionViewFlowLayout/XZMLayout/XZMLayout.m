...
-(void)prepareLayout{
    jobsByVoidBlock action = ((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(XZMLayout.class, @selector(jobsPrepareLayout)))(self, @selector(jobsPrepareLayout));
    if (action) action();
}
