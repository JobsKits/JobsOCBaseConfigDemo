...
@interface NSTimer (JobsLocalPropertyDSLAutogen_dcf8b49a29)
...
@interface JobsTimerTargetProxy (JobsPropertyDSLSetterAutogen_dcf8b49a29)
...
@interface JobsTimer (JobsPropertyDSLSetterAutogen_dcf8b49a29)
...
@implementation NSTimer (JobsLocalPropertyDSLAutogen_dcf8b49a29)
-(JobsRetNSTimerByNSDateBlock _Nonnull)byFireDate{
    @jobs_weakify(self)
