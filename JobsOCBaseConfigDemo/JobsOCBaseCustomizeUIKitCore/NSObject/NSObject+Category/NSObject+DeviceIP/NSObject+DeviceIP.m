...
-(jobsByjobsByIpifyModelBlockBlock _Nonnull)getIpify{
    @jobs_weakify(self)
    return ^(jobsByIpifyModelBlock _Nullable successBlock){
        @jobs_strongify(self)
        if (!self) return;
        // self.tipsByApi(self);
        @jobs_weakify(self)
...
-(jobsByjobsByIPApiModelBlockBlock _Nonnull)getIP{
    @jobs_weakify(self)
    return ^(jobsByIPApiModelBlock _Nullable successBlock){
        @jobs_strongify(self)
        if (!self) return;
        // self.tipsByApi(self);
        @jobs_weakify(self)
...
-(jobsByjobsByIpinfoModelBlockBlock _Nonnull)getIPInfo{
    @jobs_weakify(self)
    return ^(jobsByIpinfoModelBlock _Nullable successBlock){
        @jobs_strongify(self)
        if (!self) return;
        // self.tipsByApi(self);
        @jobs_weakify(self)
