...
@interface UIPopoverPresentationController (JobsLocalPropertyDSLAutogen_ed11a5d14e)
...
@implementation UIPopoverPresentationController (JobsLocalPropertyDSLAutogen_ed11a5d14e)
-(JobsRetUIPopoverPresentationControllerByCGRectBlock _Nonnull)bySourceRect{
    @jobs_weakify(self)
