...
@interface JobsOCRefreshSlot (JobsPropertyDSLSetterAutogen_0fdfa11067)
...
@interface JobsOCRefreshProxy (JobsPropertyDSLSetterAutogen_0fdfa11067)
...
- (void)dealloc {
    (((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsOCRefreshProxy.class, @selector(removeObservers)))(self, @selector(removeObservers)))();
}
