...
/**
 ...
 1、建议用RAC进行键盘管理，因为过滤字符比如emoji字符会很难处理
    1.1、关注：@implementation UITextField (Extra) -(void)jobsTextFieldEventFilterBlock:(JobsRetBOOLByIDBlock)filterBlock subscribeNextBlock:(jobsByIDBlock)subscribeNextBlock；
