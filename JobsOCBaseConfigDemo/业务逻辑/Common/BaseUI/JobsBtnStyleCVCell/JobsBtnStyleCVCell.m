...
-(JobsRetWKWebViewByVoidBlock _Nonnull)jobsWebView;
...
-(void)setViewModel:(UIViewModel *)viewModel{
    jobsByViewModelBlock action = ((jobsByViewModelBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsBtnStyleCVCell.class, @selector(jobsSetViewModel)))(self, @selector(jobsSetViewModel));
...
-(void)setButtonModel:(UIButtonModel *)buttonModel{
    jobsByButtonModelBlock action = ((jobsByButtonModelBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsBtnStyleCVCell.class, @selector(jobsSetButtonModel)))(self, @selector(jobsSetButtonModel));
...
-(WKWebView *)webView{
    return (((JobsRetWKWebViewByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsBtnStyleCVCell.class, @selector(jobsWebView)))(self, @selector(jobsWebView)))();
}
