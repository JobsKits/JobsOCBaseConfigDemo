...
- (void)drawRect:(CGRect)rect {
    jobsByFrameBlock action = ((jobsByFrameBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(CutomView.class, @selector(jobsDrawRect)))(self, @selector(jobsDrawRect));
...
-(JobsRetCGRectByCTFrameRefBlock _Nonnull)calculateImageRectWithFrame{
    @jobs_weakify(self)
    return ^CGRect(CTFrameRef frame){
        @jobs_strongify(self)
