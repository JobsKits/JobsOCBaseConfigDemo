...
@interface JXCategoryPopupSubVC (JobsPropertyDSLSetterAutogen_1bc3322e66)
...
@interface LOTAnimationView (JobsLocalPropertyDSLAutogen_1bc3322e66)
...
@implementation LOTAnimationView (JobsLocalPropertyDSLAutogen_1bc3322e66)
-(JobsRetLOTAnimationViewByCGFloatBlock _Nonnull)byAnimationSpeed{
    @jobs_weakify(self)
