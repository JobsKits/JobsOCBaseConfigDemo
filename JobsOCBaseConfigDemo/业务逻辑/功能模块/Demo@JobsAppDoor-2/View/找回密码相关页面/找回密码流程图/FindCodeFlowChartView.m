...
-(void)drawRect:(CGRect)rect{
    jobsByFrameBlock action = ((jobsByFrameBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(FlowChartSingleElementView.class, @selector(jobsDrawRect)))(self, @selector(jobsDrawRect));
...
-(void)drawRect:(CGRect)rect{
    jobsByFrameBlock action = ((jobsByFrameBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(FindCodeFlowChartView.class, @selector(jobsDrawRect)))(self, @selector(jobsDrawRect));
    if (action) action(rect);
}
...
-(jobsByVoidBlock _Nonnull)makeFlowChart{
    @jobs_weakify(self)
    return ^{
        @jobs_strongify(self)
        if (!self) return;
