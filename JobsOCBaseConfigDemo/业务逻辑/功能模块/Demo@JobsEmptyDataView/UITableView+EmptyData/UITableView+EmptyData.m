...
-(void)jobsReloadData{
    jobsByVoidBlock action = ((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(UITableView.class, @selector(jobsJobsReloadData)))(self, @selector(jobsJobsReloadData));
    if (action) action();
}
