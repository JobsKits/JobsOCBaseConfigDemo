...
@interface JobsLiveStreamDemoVC (JobsPropertyDSLSetterAutogen_c045682a5c)
...
@interface AVCaptureSession (JobsLocalPropertyDSLAutogen_c045682a5c)
...
@interface AVCaptureVideoPreviewLayer (JobsLocalPropertyDSLAutogen_c045682a5c)
...
@implementation AVCaptureSession (JobsLocalPropertyDSLAutogen_c045682a5c)
-(JobsRetAVCaptureSessionByNSStringBlock _Nonnull)bySessionPreset{
    @jobs_weakify(self)
...
@implementation AVCaptureVideoPreviewLayer (JobsLocalPropertyDSLAutogen_c045682a5c)
-(JobsRetAVCaptureVideoPreviewLayerByAVLayerVideoGravityBlock _Nonnull)byVideoGravity{
    @jobs_weakify(self)
