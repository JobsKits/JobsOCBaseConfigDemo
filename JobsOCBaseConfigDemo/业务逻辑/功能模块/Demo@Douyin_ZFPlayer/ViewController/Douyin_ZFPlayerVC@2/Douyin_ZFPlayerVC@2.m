...
-(BOOL)shouldAutorotate{
    return (((JobsRetBOOLByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(Douyin_ZFPlayerVC_2.class, @selector(jobsShouldAutorotate)))(self, @selector(jobsShouldAutorotate)))();
}
...
-(BOOL)prefersStatusBarHidden{
    JobsRetBOOLByVoidBlock action = ((JobsRetBOOLByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(Douyin_ZFPlayerVC_2.class, @selector(jobsPrefersStatusBarHidden)))(self, @selector(jobsPrefersStatusBarHidden));
