...
@interface UISceneSessionActivationRequest (JobsLocalPropertyDSLAutogen_a570e112e6)
...
@interface UIWindowScene (JobsLocalPropertyDSLAutogen_a570e112e6)
...
@implementation UISceneSessionActivationRequest (JobsLocalPropertyDSLAutogen_a570e112e6)
-(JobsRetUISceneSessionActivationRequestByNSUserActivityBlock _Nonnull)byUserActivity{
    @jobs_weakify(self)
...
@implementation UIWindowScene (JobsLocalPropertyDSLAutogen_a570e112e6)
-(JobsRetUIWindowSceneByNSUserActivityBlock _Nonnull)byUserActivity{
    @jobs_weakify(self)
