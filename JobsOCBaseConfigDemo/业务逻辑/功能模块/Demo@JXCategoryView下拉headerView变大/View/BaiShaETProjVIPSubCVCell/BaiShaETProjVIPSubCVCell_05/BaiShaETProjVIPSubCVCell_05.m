...
-(UIViewModel *_Nullable)getViewModel{
    JobsRetViewModelByVoidBlock action = ((JobsRetViewModelByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(BaiShaETProjVIPSubCVCell_05.class, @selector(jobsGetViewModel)))(self, @selector(jobsGetViewModel));
...
+(instancetype)cellWithCollectionView:(nonnull UICollectionView *)collectionView
    ...
    BaiShaETProjVIPSubCVCell_05 *cell = JobsRegisterDequeueCollectionViewCell(BaiShaETProjVIPSubCVCell_05);
