...
@interface JXCategoryIndicatorLineView (JobsLocalPropertyDSLAutogen_9e2e77eb98)
...
@interface JXPagerView (JobsLocalPropertyDSLAutogen_9e2e77eb98)
...
@implementation JXPagerView (JobsLocalPropertyDSLAutogen_9e2e77eb98)
-(JobsRetJXPagerViewByNSIntegerBlock _Nonnull)byPinSectionHeaderVerticalOffset{
    @jobs_weakify(self)
