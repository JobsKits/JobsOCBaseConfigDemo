...
// JOBS_PROPERTY_DSL_SETTER_DECLARATION_AUTOGEN_BEGIN JobsVerticalMenuVC_1
@interface JobsVerticalMenuVC_1 (JobsPropertyDSLSetterAutogen_af2e2cd87c)
-(void)setSearchMode:(BOOL)data;
-(void)setSearchViewWidthConstraint:(MASConstraint * _Nullable)data;
@end
// JOBS_PROPERTY_DSL_SETTER_DECLARATION_AUTOGEN_END JobsVerticalMenuVC_1
...
-(void)loadView{
    jobsByVoidBlock action = ((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsVerticalMenuVC_1.class, @selector(jobsLoadView)))(self, @selector(jobsLoadView));
    if (action) action();
}
...
- (void)viewDidLoad {
    jobsByVoidBlock action = ((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsVerticalMenuVC_1.class, @selector(jobsViewDidLoad)))(self, @selector(jobsViewDidLoad));
    if (action) action();
}
...
-(void)viewWillAppear:(BOOL)animated{
    jobsByBOOLBlock action = ((jobsByBOOLBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsVerticalMenuVC_1.class, @selector(jobsViewWillAppear)))(self, @selector(jobsViewWillAppear));
...
-(void)viewWillLayoutSubviews{
    jobsByVoidBlock action = ((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsVerticalMenuVC_1.class, @selector(jobsViewWillLayoutSubviews)))(self, @selector(jobsViewWillLayoutSubviews));
    if (action) action();
}
...
-(void)viewDidLayoutSubviews{
    jobsByVoidBlock action = ((jobsByVoidBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsVerticalMenuVC_1.class, @selector(jobsViewDidLayoutSubviews)))(self, @selector(jobsViewDidLayoutSubviews));
    if (action) action();
}
...
-(void)viewDidAppear:(BOOL)animated{
    jobsByBOOLBlock action = ((jobsByBOOLBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsVerticalMenuVC_1.class, @selector(jobsViewDidAppear)))(self, @selector(jobsViewDidAppear));
    if (action) action(animated);
}
...
-(void)viewWillDisappear:(BOOL)animated{
    jobsByBOOLBlock action = ((jobsByBOOLBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsVerticalMenuVC_1.class, @selector(jobsViewWillDisappear)))(self, @selector(jobsViewWillDisappear));
    if (action) action(animated);
}
...
#pragma mark —— 一些私有方法
-(jobsByVoidBlock _Nonnull)makeSubVC{
    @jobs_weakify(self)
    return ^(){
        @jobs_strongify(self)
        ...
        for (int i = 0; i < self.titleMutArr.count; i++){
            ...
            subVC.byContentIndex(i);
            self.vcs.add(subVC);
        }
    };
}

-(jobsByVCBlock _Nonnull)displayViewController{
    @jobs_weakify(self)
...
didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    (((jobsByVCBlock (*)(__typeof__(self), SEL))JobsBlockInstanceMethodIMP(JobsVerticalMenuVC_1.class, @selector(displayViewController)))(self, @selector(displayViewController)))(self.vcs[indexPath.row]);
}
...
// JOBS_PROPERTY_DSL_IMPLEMENTATION_AUTOGEN_BEGIN JobsVerticalMenuVC_1
-(JobsRetJobsVerticalMenuVC_1ByBOOLBlock _Nonnull)bySearchMode{
    @jobs_weakify(self)
    return ^__kindof JobsVerticalMenuVC_1 * _Nullable(BOOL data){
        @jobs_strongify(self)
...
-(JobsRetJobsVerticalMenuVC_1ByMASConstraintBlock _Nonnull)bySearchViewWidthConstraint{
    @jobs_weakify(self)
    return ^__kindof JobsVerticalMenuVC_1 * _Nullable(MASConstraint * _Nullable data){
        @jobs_strongify(self)
        [self setSearchViewWidthConstraint:data];
        return self;
    };
}
// JOBS_PROPERTY_DSL_IMPLEMENTATION_AUTOGEN_END JobsVerticalMenuVC_1
@end
