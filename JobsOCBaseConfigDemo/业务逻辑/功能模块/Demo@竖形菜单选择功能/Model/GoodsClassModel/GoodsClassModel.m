...
+(NSDictionary *)mj_replacedKeyFromPropertyName{
    return (((JobsRetDicByVoidBlock (*)(__typeof__(self), SEL))JobsBlockClassMethodIMP(GoodsClassModel.class, @selector(jobsMJReplacedKeyFromPropertyName)))(self, @selector(jobsMJReplacedKeyFromPropertyName)))();
}
...
+(NSDictionary *)mj_objectClassInArray{
    return (((JobsRetDicByVoidBlock (*)(__typeof__(self), SEL))JobsBlockClassMethodIMP(GoodsClassModel.class, @selector(jobsMJObjectClassInArray)))(self, @selector(jobsMJObjectClassInArray)))();
}
